...
urlpatterns = [
    ...
    path("<int:pk>/items/add/", views.add_activity_item, name="item-add"),
    path("<int:pk>/items/<int:item_pk>/edit/", views.ActivityItemUpdateView.as_view(), name="item-update"),
    path("<int:pk>/items/<int:item_pk>/status/<str:status>/", views.update_activity_item_status, name="item-status"),
