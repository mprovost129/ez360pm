...
urlpatterns = [
    ...
    path("<int:pk>/forms/<int:form_pk>/access/<str:action>/", client_form_views.ProjectClientFormAccessView.as_view(), name="client-form-access"),
    path("<int:pk>/forms/<int:form_pk>/uploads/<int:upload_pk>/download/", client_form_views.ProjectFormUploadDownloadView.as_view(), name="client-form-upload-download"),
